...
namespace Seki.App.Utils
{
    ...
    {
        private static readonly Dictionary<int, string> SpecialCharacterMap = new Dictionary<int, string>
        {
            { 186, ";" },
            { 187, "=" },
            { 188, "," },
        ...
        private static readonly Dictionary<int, string> ShiftedSpecialCharacterMap = new Dictionary<int, string>
        {
            { 186, ":" },
            { 187, "+" },
            { 188, "<" },
        ...
        public static (string keyText, bool isAction) MapWindowsKeyToTextOrAction(VirtualKey windowsKey, int originalKey, bool shiftPressed = false, bool ctrlPressed = false, bool altPressed = false)
        {
            ...
            // Existing logic for alphabet and number keys
